...
Espo.define('pim:views/category-image/record/list-in-category', 'pim:views/record/list',
    Dep => Dep.extend({
        ...
        actionQuickView: function (data) {
            ...
            var viewName = this.getMetadata().get(['clientDefs', 'Category', 'relationshipPanels', 'categoryImages', 'modalDetailView'])
                || this.getMetadata().get('clientDefs.' + scope + '.modalViews.detail')
                || 'views/modals/detail';
            var layoutName = this.getMetadata().get(['clientDefs', 'Category', 'relationshipPanels', 'categoryImages', 'detailLayout']);
            ...
            if (!this.quickDetailDisabled) {
                ...
                var options = {
                    ...
                    categoryId: this.getParentView().model.id,
        ...
        actionQuickEdit: function (data) {
            ...
            var viewName = this.getMetadata().get(['clientDefs', 'Category', 'relationshipPanels', 'categoryImages', 'modalEditView'])
