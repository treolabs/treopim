    ...
    <div class="panel-heading">
        <div>
            ...
            <div class="pull-right btn-group">
                {{#if createAction}}
                <button type="button" class="btn btn-default btn-sm action btn-icon" data-action="addChannelAttribute" data-channel="{{channelId}}" title="{{translate 'Add'}}"><span class="fas fa-plus"></span></button>
                {{/if}}
                {{#if actionList}}
                ...
                <ul class="dropdown-menu">
                    {{#each actionList}}
                    <li><a href="javascript:" class="action" data-action="{{data.action}}" data-channel="{{data.channelId}}">{{label}}</a></li>
                    {{/each}}
                </ul>
                {{/if}}
            </div>
